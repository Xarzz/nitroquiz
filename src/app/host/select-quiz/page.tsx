                            ...
                            <div className="flex-1">
                                <div className="relative group/search">
                                    ...
                                    <Input type="text" placeholder={t('select_quiz.search_placeholder')} value={searchInput}
                                        ...
                                        className="w-full bg-white/[0.03] border border-white/[0.07] pl-12 h-12 text-white font-display text-xs uppercase tracking-widest placeholder:text-gray-600 rounded-xl focus-visible:ring-1 focus-visible:ring-[#00ff9d]/50 focus-visible:border-[#00ff9d]/50 focus-visible:bg-white/[0.05] transition-all" />
                                </div>
                            </div>
