...
export default function Home() {
  ...
  return (
    <div className="bg-[#04060f] text-white min-h-screen relative overflow-hidden font-body selection:bg-[#2d6af2] selection:text-white flex flex-col">
      ...
      <main className="relative z-20 flex flex-col items-center justify-center h-screen w-full max-w-7xl mx-auto p-4 md:p-6">
        <header className="text-center mb-6 md:mb-8 relative z-30 w-full flex flex-col items-center">
          <div className="relative group">
            <Image
              ...
              width={500}
              height={150}
              className="object-contain w-[240px] md:w-[380px] drop-shadow-[0_0_30px_rgba(45,106,242,0.6)] group-hover:drop-shadow-[0_0_40px_rgba(45,106,242,0.8)] transition-all duration-500 scale-95 group-hover:scale-100"
              priority
            />
          </div>
            ...
            >
              {[
                ...
                <div key={item.word} className="flex items-center">
                  <span 
                    className="font-display text-[9px] sm:text-base md:text-xl font-black italic tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.3em] transition-all duration-300 cursor-default hover:text-[#00ff9d] hover:scale-110 hover:skew-x-[-12deg] active:scale-95"
                    style={{ 
                      color: item.color,
                  ...
                  {idx < 2 && (
                    <div className="mx-1 sm:mx-2 md:mx-3 w-1 h-1 md:w-1.2 md:h-1.2 rounded-full bg-[#2d6af2] shadow-[0_0_10px_#2d6af2]" />
                  )}
                </div>
              ))}
            </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-6 lg:gap-10 w-full justify-center items-stretch max-w-5xl">
          {/* Host Card */}
          <div className="host-card rounded-[2rem] p-6 md:p-8 flex-1 flex flex-col items-center justify-between gap-8 relative overflow-hidden group transition-all duration-300">
            ...
            <div className="w-full text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#000000]/50 border border-white/10 mb-4 shadow-[0_4px_15px_rgba(0,0,0,0.5)]">
                <Gamepad2 className="w-7 h-7 text-[#00ff9d]" />
              </div>
              <h2 className="font-body font-bold text-3xl text-white mb-2 tracking-wide glow-text uppercase">
            ...
            <div className="w-full">
              <button
                onClick={handleHost}
                className="w-full bg-gradient-to-r from-[#1a45c4] via-[#2d6af2] to-[#1a45c4] hover:shadow-[0_0_20px_rgba(45,106,242,0.6)] text-white font-display text-xs py-3.5 px-6 rounded-xl transition-all duration-300 uppercase tracking-wider transform active:scale-[0.98] font-bold"
              >
          ...
          {/* Join Card */}
          <div className="join-card rounded-[2rem] p-6 md:p-8 flex-1 flex flex-col items-center justify-center gap-8 relative overflow-hidden group transition-all duration-300">
            ...
            <div className="w-full text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#000000]/50 border border-white/10 mb-4 shadow-[0_4px_15px_rgba(0,0,0,0.5)]">
                <LogIn className="w-7 h-7 text-[#2d6af2]" />
              </div>
              <h2 className="font-body font-bold text-3xl text-white mb-2 tracking-wide glow-text uppercase">
            ...
            <div className="w-full space-y-2">
              <div className="relative group/input">
                <input
                  className="w-full bg-white/[0.03] border border-white/[0.07] text-white font-display text-center text-sm py-3.5 px-4 rounded-xl focus:outline-none focus:border-[#00ff9d]/60 focus:bg-white/[0.05] focus:shadow-[0_0_0_3px_rgba(0,255,157,0.1)] transition-all placeholder:font-display placeholder:text-xs uppercase tracking-widest placeholder:text-gray-600"
                  maxLength={6}
              ...
              <button
                onClick={handleJoin}
                className="w-full bg-gradient-to-r from-teal-500 via-[#00ff9d] to-teal-500 hover:shadow-[0_0_20px_rgba(0,255,157,0.5)] text-[#04060f] font-display text-xs py-3.5 px-6 rounded-xl transition-all duration-300 uppercase tracking-wider transform active:scale-[0.98] font-bold"
              >
